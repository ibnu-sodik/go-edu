...
<div class="row">
	<form class="form-horizontal" method="POST" enctype="multipart/form-data" role="form" action="<?= $form_action.'/'.$row['id_artikel']; ?>">
		<div class="col-md-8 col-xs-12">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="judul">Judul</label>

				<div class="col-sm-9">
					<input type="text" id="judul" placeholder="Judul" value="<?= $row['judul_artikel'] ?>" name="judul" class="form-control judul" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="slug" value="<?= $row['slug_artikel'] ?>" placeholder="Permalink" name="slug" class="form-control slug" readonly />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="form-control" name="konten" id="summernote"><?= $row['konten_artikel'] ?></textarea>
				</div>
			</div>
		</div>
		<div class="col-md-4 col-xs-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="file" name="filefoto" id="image" class="dropify" data-height="190" data-default-file="<?= base_url('uploads/artikel/'.$row['gambar_artikel']) ?>" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select class="form-control chosen-select" name="kategori" id="kategori" data-placeholder="Pilih Kategori...">
						...
						<?php foreach ($kategori->result() as $val): ?>
							<?php if ($row['id_kategori_artikel'] == $val->id_kategori): ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select multiple="" name="label[]" class="chosen-select form-control" id="label" data-placeholder="Pilih Label..." data-live-search="true">
							<?php 
							foreach ($label->result() as $val):
								$hasil = str_replace(",", " ", $row['label_artikel']);
								// var_dump($hasil);die();
							 ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea placeholder="Meta Deskripsi" name="deskripsi" for="meta-deskripsi" class="form-control" rows="10"><?= $row['deskripsi_artikel'] ?></textarea>
					</div>
				</div>
