...
<!--[if lte IE 9]>
<link rel="stylesheet" href="<?= base_url() ?>dists/css/ace-part2.min.css" />
<![endif]-->
					...
					<div class="login-container">
						<div class="center">
							<h1>
								...
								<span class="red">Reset</span>
								<span class="white" id="id-text2">Password</span>
							</h1>
							...
							<div id="login-box" class="login-box visible widget-box no-border">
								<div class="widget-body">
									<div class="widget-main">
										...
										<form method="POST" action="<?= $form_act_reset; ?>">
											<fieldset>
