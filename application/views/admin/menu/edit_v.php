								...
								<div class="form-group" id="link_agenda">									
									...
									<div class="col-sm-9 col-xs-12">
										<select name="link_agenda" class="form-control select2">
											...
											<?php 
											$rage = str_replace($url_agenda, "", $data['link']);
											foreach ($pil_agenda->result() as $row):
												if ($rage == $row->slug_agenda) {
													$cek = 'selected';
												}else{
													$cek = '';
												}
												?>
												<option value="<?= $row->slug_agenda; ?>" <?= $cek ?>><?= $row->nama_agenda; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
									...
									<div class="col-sm-9 col-xs-12">
										<select name="link_berita" class="form-control select2">
											...
											foreach ($pil_berita->result() as $row):
												...
												?>
												<option value="<?= $row->slug_berita; ?>" <?= $cek ?>><?= $row->nama_berita; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								</div>
