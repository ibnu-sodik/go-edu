...
<div class="row">
	<form class="form-horizontal" method="POST" enctype="multipart/form-data" role="form" action="<?= $form_action.'/'.$data->id_kontak; ?>">
		<div class="col-md-4 col-xs-12">
			<div class="form-group">
				<label class="col-sm-3 no-padding-right control-label" for="gambar_kontak">Gambar Kontak</label>
				<div class="col-sm-9">
					<input type="file" name="filefoto" id="gambar_kontak" class="dropify" data-height="300" data-default-file="<?= $src ?>" />
				</div>
			</div>
		</div>
		<div class="col-md-8 col-xs-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="konten_kontak" class="form-control" id="konten_kontak"><?= $data->konten_kontak ?></textarea>
				</div>
			</div>
		</div>
		<div class="col-md-12 col-xs-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea name="konten_peta" class="form-control" id="konten_peta"><?= $data->konten_peta; ?></textarea>
				</div>
			</div>
		</div>
